...
extern	phys_addr_t ram_console_memory_base;
...
static int __init ram_console_device_init(void)
{
	...
	res->start = ram_console_memory_base;
	res->end = ram_console_memory_base + 0x00100000 - 1;
...
core_initcall(ram_console_device_init);
#endif