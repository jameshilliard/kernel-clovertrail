...
#define GP_CAMERA_POWER_2P8	"camera_2p8"
#define GP_CAMERA_1_1P8	"camera_1p8"
#define GP_CAMERA_0_1P2	"camera_1p2"
#define GP_CAMERA_1_1P5     "camera_1p5"
//int camera_v2p8_vcm_vdd;
