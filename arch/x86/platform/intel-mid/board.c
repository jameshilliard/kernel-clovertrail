...
#include "device_libs/platform_ov9740.h"
#include "device_libs/platform_sp1628.h"
#include "device_libs/platform_adp1650.h"
#include "device_libs/platform_bu64291.h"
...
#include "device_libs/platform_imx091.h"
#include "device_libs/platform_dw9714.h"
...
#include "device_libs/platform_synaptics_rim.h"
...
struct devs_id __initconst device_ids[] = {
	...
	{"ov8830", SFI_DEV_TYPE_I2C, 0, &ov8830_platform_data,
					&intel_register_i2c_camera_device},
	{"imx091", SFI_DEV_TYPE_I2C, 0, &imx091_platform_data,
					&intel_register_i2c_camera_device},
	{"ov9740", SFI_DEV_TYPE_I2C, 0, &ov9740_platform_data,
					&intel_register_i2c_camera_device},	
{"sp1628", SFI_DEV_TYPE_I2C, 0, &sp1628_platform_data,
					&intel_register_i2c_camera_device},	
	{"adp1650", SFI_DEV_TYPE_I2C, 0, &adp1650_platform_data_func,
					&intel_register_i2c_camera_device},
        {"bu64291", SFI_DEV_TYPE_I2C, 0, &bu64291_platform_data,
					&intel_register_i2c_camera_device},
        {"dw9714", SFI_DEV_TYPE_I2C, 0, &dw9714_platform_data,
					&intel_register_i2c_camera_device},
	...
	{"synaptics_3202", SFI_DEV_TYPE_I2C, 0, &synaptics_platform_data, NULL},
#endif
	/* Modem */
#ifndef CONFIG_HSI_NO_MODEM
	...
	{"hsi_edlp_modem", SFI_DEV_TYPE_HSI, 0, &edlp_modem_platform_data,
						NULL},
/*++ZTE: cui.j modify for marvell modem 20130427 ++*/
#elif defined(CONFIG_MARVELL_MODEM_HSI)
	{"hsi_ifx_modem", SFI_DEV_TYPE_HSI, 0, &hsi_modem_platform_data, NULL},
	{"hsi_ffl_modem", SFI_DEV_TYPE_HSI, 0, &ffl_modem_platform_data, NULL},
	{"hsi_edlp_modem", SFI_DEV_TYPE_HSI, 0, &edlp_modem_platform_data,
						NULL},
