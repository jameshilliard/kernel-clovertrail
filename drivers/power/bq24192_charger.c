...
#ifdef CONFIG_PROJECT_P940V10
#define BQ24192_DEF_VBATT_MAX		4192
#else
#define BQ24192_DEF_VBATT_MAX		4370
#define MAINT_CHRG_VOL_LL         4300
#define MAINT_CHRG_VOL_UL         4370
#define MAINT_CHRG_CUR             1000
#endif
#define BQ24192_DEF_SDP_ILIM_CUR	500	/* 500mA */
#define BQ24192_DEF_DCP_ILIM_CUR	1500	/* 1500mA */
#ifdef CONFIG_PROJECT_P940V10
#define BQ24192_DEF_CHRG_CUR		1000
#else
...
#ifdef CONFIG_PROJECT_P940V10
#define CLT_BATT_CHRVOLTAGE_SET_DEF	    4192
#define CLT_BATT_DEFAULT_MAX_CAPACITY	2000
#endif
#ifdef CONFIG_PROJECT_V975
#define CLT_BATT_CHRVOLTAGE_SET_DEF	    4350
#define CLT_BATT_DEFAULT_MAX_CAPACITY	2300
#endif
#ifdef CONFIG_PROJECT_P940T01
#define CLT_BATT_CHRVOLTAGE_SET_DEF	    4350
#define CLT_BATT_DEFAULT_MAX_CAPACITY	3200
#endif
...
#define CLT_BATT_VMIN_THRESHOLD_DEF	3500	/* ori is 3600mV */
#define CLT_BATT_TEMP_MAX_DEF	50	/* ori is 45 degrees */
#define CLT_BATT_TEMP_MIN_DEF	0
#define CLT_BATT_CRIT_CUTOFF_VOLT_DEF	3400	/* ori is 3700mV */
...
#ifdef CONFIG_PROJECT_V975
extern int intel_msic_set_gpio0hv0(int value);
#endif
...
/* add for zte project 20130516 begin */
static enum power_supply_property bq24192_usb_props[] = {
	POWER_SUPPLY_PROP_ONLINE,
};

static enum power_supply_property bq24192_ac_props[] = {
	POWER_SUPPLY_PROP_ONLINE,
};

#ifdef CONFIG_PROJECT_V975
static enum power_supply_property bq24192_wireless_props[] = {
	POWER_SUPPLY_PROP_ONLINE,
};
#endif
/* add for zte project 20130516 end*/
...
static void bq24192_maintenance_worker(struct work_struct *work)
{
	 ...
	 */
	if (!chip->pdata->sfi_tabl_present) {
		dev_dbg(&chip->client->dev, "Using Platform data table\n");
		temp_mon = &chip->pdata->temp_mon_range[idx];
	} else {
		dev_dbg(&chip->client->dev, "Using SFI table data\n");
