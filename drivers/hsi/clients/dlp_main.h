...
/*++ ZTE:cj modify for marvell modem 20130322 ++*/
#ifndef CONFIG_MARVELL_MODEM_HSI
...
#else
#define DLP_HANGUP_DELAY	10000000
#define DLP_HSI_TX_DELAY	100000
#define DLP_HSI_RX_DELAY	100000
#endif
/*-- ZTE:cj modify for marvell modem 20130322 */
...
#else
#define DLP_HSI_TX_CTRL_FIFO	10
#define DLP_HSI_RX_CTRL_FIFO	10

#define DLP_HSI_TX_WAIT_FIFO	16
#define DLP_HSI_RX_WAIT_FIFO	16
#endif

/* PDU size for TTY channel */
#define DLP_TTY_TX_PDU_SIZE		4096	/* 4 KBytes */
#define DLP_TTY_RX_PDU_SIZE		4096	/* 4 KBytes */
/*++ ZTE:cj modify for marvell modem 20130309 ++*/
#ifndef CONFIG_MARVELL_MODEM_HSI
#define DLP_TTY_HEADER_LENGTH	16
#else
#define DLP_TTY_HEADER_LENGTH	0
#define DLP_TTY_TX_PDU_SIZE_LARGE	(1024*32)	/* 16 KBytes */
#define DLP_TTY_RX_PDU_SIZE_LARGE	(1024*32)	/* 16 KBytes */
/*-- ZTE:cj modify for marvell modem 20130309 */
#endif
...
#ifdef CONFIG_MARVELL_MODEM_HSI
#define EDLP_MRVL_TX_DATA_REPORT     (dlp_drv.debug & 0x1000)
#define EDLP_MRVL_RX_DATA_REPORT     (dlp_drv.debug & 0x2000)
#endif
...
#else
	DLP_CHANNEL_TTY0,	/* HSI Channel 1 */
	DLP_CHANNEL_TTY1,	/* HSI Channel 2 */
	DLP_CHANNEL_TTY2,	/* HSI Channel 3 */
	DLP_CHANNEL_TTY3,	/* HSI Channel 4 */
	DLP_CHANNEL_TTY4,	/* HSI Channel 4 */
	DLP_CHANNEL_TTY5,	/* HSI Channel 5 */
	DLP_CHANNEL_TTY6,	/* HSI Channel 6 */
#endif
/*-- ZTE:cj modify for marvell modem 20130309 --*/
	DLP_CHANNEL_COUNT
};
...
/*++ ZTE:cj modify for marvell modem 20130310 ++*/
#ifdef CONFIG_MARVELL_MODEM_HSI
	struct completion cmd_txfer_done;
	struct completion cmd_rxfer_done;
	struct task_struct *data_xfer_thread;
	struct completion data_xfer_notify;
	struct completion data_xfer_ready;
	struct completion data_xfer_done;
	struct completion data_xfer_close;
	struct completion data_tx_sync;
	unsigned int state;
#endif
/*-- ZTE:cj modify for marvell modem 20130310 --*/
...
#ifdef CONFIG_MARVELL_MODEM_HSI
	struct work_struct boot_handshake;
	struct workqueue_struct *handshake_wq;
	struct hsi_client *client;
	u32 handshake_err_code;
	struct completion handshake_over;
	int channel_status;
	char* rxbuffer;
#endif
/*-- cj modify for marvell modem 20130310 --*/
