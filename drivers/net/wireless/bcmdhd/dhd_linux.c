...
int net_os_rxfilter_add_remove(struct net_device *dev, int add_remove, int num)
{
	...
	case DHD_BROADCAST_FILTER_NUM:
		...
		filterp = add_remove ? "105 0 0 12 0xFFFF00000000000000000000000000000000000000FF 0x080000000000000000000000000000000000000000FF" : NULL;
		break;
	case DHD_MULTICAST4_FILTER_NUM:
		num = DHD_IPV4_MC_224_FILTER_NUM;
		filterp = add_remove ? "106 0 0 12 0xFFFF00000000000000000000000000000000F0 0x080000000000000000000000000000000000E0" : NULL;
		break;
	case DHD_MULTICAST6_FILTER_NUM:
		num = DHD_IPV6_MC_FF00_FILTER_NUM;
		filterp = add_remove ? "107 0 0 12 0xFFFF000000000000000000000000000000000000000000000000FF 0x86DD000000000000000000000000000000000000000000000000FF" : NULL;
		break;
	default:
		num = 0;
		break;
