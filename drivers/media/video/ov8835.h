...
static const struct ov8830_reg ov8835_basic_settings[] = {
	...
	{ OV8830_8BIT, { 0x3021 }, 0x20 },   // modify by zte yaoling for camera ov8835 temperature extra high issue
	...
	{ OV8830_8BIT, { 0x3600 }, 0xb8 },  // modify by zte yaoling for camera ov8835 temperature extra high issue
	...
	{ OV8830_8BIT, { 0x3622 }, 0x0b },  // modify by zte yaoling for camera ov8835 temperature extra high issue
...
static struct ov8830_resolution ov8835_res_video[] = {
	...
	},
	{
		 ...
		 .bin_factor_y = 1,
		// .skip_frames = 1,
		/* modify  by yaoling for video switch 1080P to QVGA   green issue  0621   */
		.skip_frames = 5,
		 .fps_options = {
			{
				 .fps = 30,
