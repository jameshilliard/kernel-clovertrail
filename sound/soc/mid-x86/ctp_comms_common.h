...
static const char *ext_pa_text[] = {"Disable", "Enable"};
static const struct soc_enum ext_pa_enum =
	SOC_ENUM_SINGLE_EXT(2, ext_pa_text);
#endif

static const char * const fm_state_text[] = {"off", "on"};
static const struct soc_enum fm_state_enum =
	SOC_ENUM_SINGLE_EXT(2, fm_state_text);
#endif
